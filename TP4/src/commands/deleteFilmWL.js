...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('delete_film_wl')
        .setDescription('Supprime un film d une watchlist')
    ...
    async execute(interaction) {
        ...
        const { data } = await axios.post('http://localhost:3000/watchlists/deleteFilmWL', {
            "pseudo": pseudo,
            "nom_WL": nom_WL,
            "titre": titre,
        });
