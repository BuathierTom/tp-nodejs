...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('favoris_wl')
        .setDescription('Ajoute une watchlist en favoris')
    ...
    async execute(interaction) {
        ...
        const { data } = await axios.post('http://localhost:3000/watchlists/favorisWL', {
            "pseudo": pseudo,
            "nom_WL": nom_WL,
        });
        ...
        const winEmbed = new EmbedBuilder()
            ...
            .setAuthor({name: interaction.user.username, iconURL: interaction.user.avatarURL()})
            .setDescription(`La watchlist **${nom_WL}** a été ajouté en favoris avec succès !`)
            .setTimestamp()
