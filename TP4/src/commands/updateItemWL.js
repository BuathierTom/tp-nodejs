...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('update_item_wl')
        .setDescription('Met à jour un item d une watchlist')
    ...
    async execute(interaction) {
        ...
        const { data } = await axios.post('http://localhost:3000/watchlists/updateItemWL', {
            "pseudo": pseudo,
            "nom_WL": nom_WL,
            "titre": titre,
            "statut": statut,
